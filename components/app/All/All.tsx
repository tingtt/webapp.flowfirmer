...
export default function All() {
  ...
  const [delayedToDosShown, setDelayedToDosShown] =
    React.useState<boolean>(true)
  const [todayPendingToDosShown, setTodayPendingToDosShown] =
    React.useState<boolean>(true)
  const [tomorrowPendingToDosShown, setTomorrowPendingToDosShown] =
    React.useState<boolean>(true)
  const [laterPendingToDosShown, setLaterPendingToDosShown] =
    React.useState<boolean>(true)
  const [completedToDosShown, setCompletedToDosShown] =
    React.useState<boolean>(true)
  ...
  const [snackBarState, setSnackBarState] = React.useState<{
    open: boolean
    msg: string
    type?: "todoCompleted" | "todoDeleted"
  }>({ open: false, msg: "" })
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.contentLeft}>
        ...
        {todos != undefined && (
          <div className={classes.list}>
            ...
            {todos.filter(
              (value) =>
                !value.completed && value.startDatetimeScheduled == undefined
            ).length > 0 && (
              <Collapse in={noDateToDosShown} collapsedSize="33px">
                ...
                {todos
                  ...
                  .map((value) => (
                    <div className={classes.todoListItemDiv} key={value.id}>
                      <ToDoListItem
                        key={value.id}
                        todo={value}
                        setTodos={setTodos}
                      ...
                      />
                      <Divider className={classes.todoListDivider} />
                    </div>
                  ))}
              </Collapse>
            )}
            ...
            {todos.filter(
              (value) =>
                ...
                (() => {
                  const date = new Date()
                  return (
                    (value.startDatetimeScheduled.getFullYear() * 100 +
                      value.startDatetimeScheduled.getMonth()) *
                      100 +
                      value.startDatetimeScheduled.getDate() <
                    (date.getFullYear() * 100 + date.getMonth()) * 100 +
                      date.getDate()
                  )
                })()
            ).length > 0 && (
                  ...
                  .sort((a, b) => {
                    ...
                    if (a.startDatetimeScheduled == undefined) {
                      ...
                      if (b.startDatetimeScheduled == undefined) {
                        ...
                        a.startDatetimeScheduled < b.startDatetimeScheduled
                          ? (comparison = -1)
                          : (comparison = 1)
                      }
                    }
            ...
            {todos.filter((value) => {
              ...
              return (
                value.startDatetimeScheduled.getFullYear() ==
                  date.getFullYear() &&
                value.startDatetimeScheduled.getMonth() == date.getMonth() &&
                value.startDatetimeScheduled.getDate() == date.getDate()
              )
            }).length > 0 && (
              <Collapse in={todayPendingToDosShown} collapsedSize="33px">
                <div
                  className={classes.accordionToggleButtonDiv}
                  onClick={() =>
                    setTodayPendingToDosShown((current) => !current)
                  }
                >
                  <ArrowDropDown
                    className={clsx(classes.accordionIcon, {
            ...
            {todos.filter((value) => {
              ...
              <Collapse in={tomorrowPendingToDosShown} collapsedSize="33px">
                <div
                  className={classes.accordionToggleButtonDiv}
                  onClick={() =>
                    setTomorrowPendingToDosShown((current) => !current)
                  }
                >
                  <ArrowDropDown
                    className={clsx(classes.accordionIcon, {
            ...
            {todos.filter((value) => {
              ...
              return (
                ...
                `${value.startDatetimeScheduled.getFullYear()}${value.startDatetimeScheduled.getMonth()}${value.startDatetimeScheduled.getDate()}`
              )
            }).length > 0 && (
              <Collapse in={laterPendingToDosShown} collapsedSize="33px">
                <div
                  className={classes.accordionToggleButtonDiv}
                  onClick={() =>
                    setLaterPendingToDosShown((current) => !current)
                  }
                >
                  <ArrowDropDown
                    className={clsx(classes.accordionIcon, {
      ...
      <div className={classes.contentRight}>
        ...
        {todos != undefined &&
          todos
            .filter((value) => value.id == selectedToDoId)
            .map((value) => (
              <div key={value.id}>
                <ToDoDetail
                  todo={value}
